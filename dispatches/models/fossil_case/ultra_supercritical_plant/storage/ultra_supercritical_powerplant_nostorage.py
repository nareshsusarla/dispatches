...
#   At this time one can make chnages to the model for further analysis
    ...
    for i in flow_frac_list:
        for j in pres_frac_list:
            ...
            m.fs.boiler.inlet.flow_mol.setlb(0*17854)
            m.fs.boiler.inlet.flow_mol.setub(1.2*17854)
            # m.fs.plant_power_out[0].fix(475)
...
if __name__ == "__main__":
    ...
    view_result("pfd_usc_powerplant_result_530.svg", m_result)
