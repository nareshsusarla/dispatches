...
def add_bounds(m):
    ...
    for oil_hxc in [m.fs.charge.thermal_oil_disjunct.hxc]:
        ...
        oil_hxc.tube.properties_in[:].enthalpy_mass.setub(m.fs.charge.thermal_oil_enthalpy_mass_max * m.factor)
        oil_hxc.tube.properties_out[:].enthalpy_mass.setlb(m.fs.charge.thermal_oil_enthalpy_mass_min / m.factor)
        oil_hxc.tube.properties_out[:].enthalpy_mass.setub(m.fs.charge.thermal_oil_enthalpy_mass_max * m.factor)
        #--------
        # bounds for costing
    ...
    # These bounds are now included in each Var, in bounds()
