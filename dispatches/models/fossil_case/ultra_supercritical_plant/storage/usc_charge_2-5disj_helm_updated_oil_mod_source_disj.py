...
def create_charge_model(m):
    ...
    ###########################################################################
    #  Add constraints and create the stream arcs
    ###########################################################################
    _make_constraints(m)
...
def _make_constraints(m):
    ...
    #-------- modified by esrawli
    # Replace the equality constraint for an inequality constraint
    # HX pump
...
def model_analysis(m, solver, heat_duty=None):
    ...
    #-------- added by esrawli
    # Deactivate production constraint from base model and include the
    # corrected constraint that now includes the HX pump power: Plant
    # Power Out = Total Turbine Power - HX pump power
