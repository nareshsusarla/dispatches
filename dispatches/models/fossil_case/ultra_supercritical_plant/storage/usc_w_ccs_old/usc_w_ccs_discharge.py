...
def print_model(nlp_model, nlp_data):
    ...
    if nlp.condpump_source_disjunct.binary_indicator_var.value == 1:
        ...
        print('        Disjunction 1: Water from FWH1 is sourced')
    elif (nlp.fwh2_source_disjunct.binary_indicator_var.value == 1):
        print('        Disjunction 1: Water from FWH2 is sourced')
    elif (nlp.fwh3_source_disjunct.binary_indicator_var.value == 1):
        print('        Disjunction 1: Water from FWH3 is sourced')
        ...
        print('        Disjunction 1: Water from FWH5 is sourced')
        ...
        print('        Disjunction 1: Water from FWH6 is sourced')
        ...
        print('        Disjunction 1: Water from FWH8 is sourced')
...
if __name__ == "__main__":
    ...
    # source = ["condpump", "booster", "bfp", "fwh9", "fwh4", "fwh6", "fwh8"]

    m = model_analysis(m, solver, heat_duty=148.5, source="fwh2")
    # results = solver.solve(
    #     m,
    #     tee=True,
    #     symbolic_solver_labels=True,
