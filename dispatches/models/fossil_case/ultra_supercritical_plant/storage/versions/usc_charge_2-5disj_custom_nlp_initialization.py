...
def add_bounds(m, source=None):
    ...
    m.fs.charge.hitec_salt_disjunct.hxc.delta_temperature_out.setub(80)
...
def print_model(nlp_model, nlp_data):
    ...
    if nlp_model.fs.charge.solar_salt_disjunct.indicator_var.value == 1:
        ...
        print('No more storage fluids available')
...
if __name__ == "__main__":
    ...
    heat_duty_data = [150]
    source_data = ['hp', 'vhp']
    fluid_data = ['solar_salt', 'hitec_salt']
