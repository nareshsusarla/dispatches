...
def thermal_oil_disjunct_equations(disj):
    ...
    m.fs.charge.thermal_oil_disjunct.hxc.oil_in_dynamic_viscosity = Expression(
        ...
        m.fs.charge.thermal_oil_disjunct.hxc.side_2.properties_in[0].density * 1e-6 # conversion from mm2/s to m2/s
    )
    ...
    m.fs.charge.thermal_oil_disjunct.hxc.oil_out_dynamic_viscosity = Expression(
        ...
        m.fs.charge.thermal_oil_disjunct.hxc.side_2.properties_out[0].density * 1e-6  # conversion from mm2/s to m2/s
    )
    ...
    m.fs.charge.thermal_oil_disjunct.hxc.oil_prandtl_number = Expression(
        expr=(
            m.fs.charge.thermal_oil_disjunct.hxc.side_2.properties_in[0].cp_mass
            * m.fs.charge.thermal_oil_disjunct.hxc.oil_in_dynamic_viscosity
            / m.fs.charge.thermal_oil_disjunct.hxc.side_2.properties_in[0].therm_cond),
        doc="Salt Prandtl Number")
    m.fs.charge.thermal_oil_disjunct.hxc.oil_prandtl_wall = Expression(
        expr=(
            m.fs.charge.thermal_oil_disjunct.hxc.side_2.properties_out[0].cp_mass
            * m.fs.charge.thermal_oil_disjunct.hxc.oil_out_dynamic_viscosity
            / m.fs.charge.thermal_oil_disjunct.hxc.side_2.properties_out[0].therm_cond
        ),
        doc="Salt Wall Prandtl Number"
    )
...
def build_costing(m, solver=None, optarg={"tol": 1e-8, "max_iter": 300}):
    ...
    m.fs.charge.thermal_oil_disjunct.dens_lbft3 = pyo.Expression(
        expr=m.fs.charge.thermal_oil_disjunct.hxc.side_2.properties_in[0].density * 0.062428,
        doc="pump size factor"
    )  # density in lb per ft3
...
def calculate_bounds(m):
    ...
    m.fs.charge.thermal_oil_temperature_min = 280 - m.fs.temperature_degrees # in K
    ...
    print('visc_kin min {: >18.4f} {: >12.4f} {: >12.4f}'.format(
        0, 0,
        m.fs.charge.thermal_oil_visc_kin_min))
    print('enthalpy_mass max {: >18.4f} {: >13.4f}'.format(
        m.fs.charge.solar_salt_enthalpy_mass_max, m.fs.charge.hitec_salt_enthalpy_mass_max))
    print('enthalpy_mass min {: >18.4f} {: >13.4f}'.format(
...
def add_bounds(m):
    ...
    for oil_hxc in [m.fs.charge.thermal_oil_disjunct.hxc]:
        ...
        oil_hxc.delta_temperature_in.setub(565)  # 561
        oil_hxc.delta_temperature_out.setlb(9)  # 9
        oil_hxc.delta_temperature_out.setub(255)  # 500
        #-------- modified by esrawli
        # Bounds added based on the results from Andres's model
        # oil_hxc.tube.properties_in[:].cp_mass.setlb(0)
        # oil_hxc.tube.properties_in[:].cp_mass.setub(1e6)
        # oil_hxc.tube.properties_in[:].therm_cond.setlb(0)
        # oil_hxc.tube.properties_in[:].therm_cond.setub(100)
        # oil_hxc.tube.properties_in[:].visc_kin.setlb(0)
        # oil_hxc.tube.properties_in[:].visc_kin.setub(100)
        # oil_hxc.tube.properties_in[:].density.setlb(0)
        # oil_hxc.tube.properties_in[:].density.setub(1e5)
        # oil_hxc.tube.properties_out[:].cp_mass.setlb(0)
        # oil_hxc.tube.properties_out[:].cp_mass.setub(1e6)
        # oil_hxc.tube.properties_out[:].therm_cond.setlb(0)
        # oil_hxc.tube.properties_out[:].therm_cond.setub(100)
        # oil_hxc.tube.properties_out[:].visc_kin.setlb(0)
        # oil_hxc.tube.properties_out[:].visc_kin.setub(100)
        # oil_hxc.tube.properties_out[:].density.setlb(0)
        # oil_hxc.tube.properties_out[:].density.setub(1e5)
        # Add calculated bounds
        oil_hxc.tube.properties_in[:].cp_mass.setlb(m.fs.charge.thermal_oil_cp_mass_min / m.factor)
        oil_hxc.tube.properties_in[:].cp_mass.setub(m.fs.charge.thermal_oil_cp_mass_max * m.factor)
        oil_hxc.tube.properties_out[:].cp_mass.setlb(m.fs.charge.thermal_oil_cp_mass_min / m.factor)
        oil_hxc.tube.properties_out[:].cp_mass.setub(m.fs.charge.thermal_oil_cp_mass_max * m.factor)
        oil_hxc.tube.properties_in[:].therm_cond.setlb(m.fs.charge.thermal_oil_therm_cond_min / m.factor)
        oil_hxc.tube.properties_in[:].therm_cond.setub(m.fs.charge.thermal_oil_therm_cond_max * m.factor)
        oil_hxc.tube.properties_out[:].therm_cond.setlb(m.fs.charge.thermal_oil_therm_cond_min / m.factor)
        oil_hxc.tube.properties_out[:].therm_cond.setub(m.fs.charge.thermal_oil_therm_cond_max * m.factor)
        oil_hxc.tube.properties_in[:].density.setlb(m.fs.charge.thermal_oil_density_min / m.factor)
        oil_hxc.tube.properties_in[:].density.setub(m.fs.charge.thermal_oil_density_max * m.factor)
        oil_hxc.tube.properties_out[:].density.setlb(m.fs.charge.thermal_oil_density_min / m.factor)
        oil_hxc.tube.properties_out[:].density.setub(m.fs.charge.thermal_oil_density_max * m.factor)
        oil_hxc.tube.properties_in[:].visc_kin.setlb(m.fs.charge.thermal_oil_visc_kin_min / m.factor)
        oil_hxc.tube.properties_in[:].visc_kin.setub(m.fs.charge.thermal_oil_visc_kin_max * m.factor)
        oil_hxc.tube.properties_out[:].visc_kin.setlb(m.fs.charge.thermal_oil_visc_kin_min / m.factor)
        oil_hxc.tube.properties_out[:].visc_kin.setub(m.fs.charge.thermal_oil_visc_kin_max * m.factor)
        #--------
        # bounds for costing
    ...
    # These bounds are included in the Var(), in bounds()
    ...
    # for fluid_cost in [m.fs.charge.thermal_oil_disjunct]:
        # fluid_cost.oil_purchase_cost.setlb(0)
        # fluid_cost.oil_purchase_cost.setub(1e10)
...
def model_analysis(m, solver, heat_duty=None):
    ...
    # m.fs.charge.solar_salt_disjunct.hxc_heat_duty_constraint = Constraint(
    #     expr=m.fs.charge.solar_salt_disjunct.hxc.heat_duty[0] >= heat_duty * 1e6
    # )
    # m.fs.charge.hitec_salt_disjunct.hxc_heat_duty_constraint = Constraint(
    #     expr=m.fs.charge.hitec_salt_disjunct.hxc.heat_duty[0] >= heat_duty * 1e6
    # )
    # m.fs.charge.thermal_oil_disjunct.hxc_heat_duty_constraint = Constraint(
    #     expr=m.fs.charge.thermal_oil_disjunct.hxc.heat_duty[0] >= heat_duty * 1e6
    # )
